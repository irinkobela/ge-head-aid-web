...
const translations = {
  ...
  ka: {
    ...
    // Homepage
    heroTitle: 'საქართველოს თავის ტკივილისა და მიგრენის ორგანიზაცია',
    heroSubtitle: 'ვეძღვნებით თავის ტკივილითა და მიგრენით დაზარალებულთა ცხოვრების გაუმჯობესებას კვლევის, განათლებისა და მხარდაჭერის მეშვეობით.',
